const HTML_TEMPLATE_TODAY = (nombreCliente, fechaCita, horaCita, lugarCita, userName) => {
  return `
      <!DOCTYPE html>
<html lang="es">
<head>
    ...
    <div class="container">
        <div class="email">
            ...
            <div class="email-body">
                ...
                <p>Este es un recordatorio de su cita programada hoy:</p>
...
export default HTML_TEMPLATE_TODAY;
